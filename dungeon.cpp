    ...
    bool makeCorridor(int x, int y, int lenght, int direction)
    {
        ...
        switch(dir)
        {
            case 0:
            {
                ...
                {
                    if (ytemp == (y - len)) {
					if (getCell(xtemp - 1, ytemp) == 0)
						setCell(xtemp - 1, ytemp, tileDirtWall);
					if (getCell(xtemp, ytemp) == 0)
						setCell(xtemp, ytemp, tileDirtWall);
					if (getCell(xtemp + 1, ytemp) == 0)
						setCell(xtemp + 1, ytemp, tileDirtWall);
                ...
                setCell(xtemp , ytemp+1, tileDirtWall);
                break;
...
//					> 3  hay muro
			  ...
			  if( getCell(x,y)>2  &&  getCell(x,y)<5 ){
			  		if( getCell(x-1,y)> 2 &&  getCell(x,y-1)< 3 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)< 3) return (12);
					if( getCell(x-1,y)< 3 &&  getCell(x,y-1)< 3 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)> 2) return (11);
					if( getCell(x-1,y)< 3 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)< 3 &&  getCell(x,y+1)> 2) return (16);

					if( getCell(x-1,y)> 2 &&  getCell(x,y-1)< 3 &&  getCell(x+1,y)< 3 &&  getCell(x,y+1)> 2) return (13);
					if( getCell(x-1,y)< 3 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)> 2) return (14);
					if( getCell(x-1,y)> 2 &&  getCell(x,y-1)< 3 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)> 2) return (15);

					
					if( getCell(x-1,y)> 2 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)> 2) return (17);
				//	if( getCell(x-1,y)< 3 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)> 2) return (18);
					if( getCell(x-1,y)> 2 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)< 3) return (19);
					if( getCell(x-1,y)> 2 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)< 3 &&  getCell(x,y+1)> 2) return (20);

					if( getCell(x-1,y)< 3 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)< 3) return (21);
				//	if( getCell(x-1,y)> 2 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)< 3 &&  getCell(x,y+1)> 2) return (22);
					if( getCell(x-1,y)> 2 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)< 3 &&  getCell(x,y+1)< 3) return (23);
				//	if( getCell(x-1,y)> 2 &&  getCell(x,y-1)< 3 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)> 2) return (24);
				//	if( getCell(x-1,y)> 2 &&  getCell(x,y-1)> 2 &&  getCell(x+1,y)> 2 &&  getCell(x,y+1)< 3) return (25);
				}else{
					return  getCell(x,y);
				}
...
private:
	bool createDungeon(int inx, int iny, int inobj){
		...
		for (int y = 0; y < ysize; y++){
 		...
 		setCell(xsize, ysize, tileStoneWall);
		/*******************************************************************************
		And now the code of the random-map-generation-algorithm begins!
		*******************************************************************************/
 
		//start with making a room in the middle, which we can start building upon
		makeRoom(xsize/2, ysize/2, getRand(8,12), getRand(6,10), getRand(0,3)); //getrand saken f????r att slumpa fram riktning p?? rummet
    ...
    void cmain()
    {
        ...
        while(!createDungeon(x, y, dungeon_objects))
        {
...
public:
	...
	int transi(int x, int y)
    {
    	bool transitable=false;
    	int kk=dungeon_map[x + xsize * y];
    	if(kk<3 || kk==5) transitable=true;
    	return transitable;
    ...
    Dungeon(int i,int j,int obj)
    {
        ...
        chanceCorridor = j;
 		...
 		dungeon_map = new int[xsize * ysize];
 	//	bzero(dungeon_map,xsize*ysize);
        while(!createDungeon(xsize, ysize, objects))
        {
